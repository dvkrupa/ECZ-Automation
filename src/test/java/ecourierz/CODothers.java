...
import utils.CODothersUtils;
import utils.ReadExcelCODothers;



public class CODothers extends CODothersUtils{
	...
	@Test (dataProvider = "cod_others")
	public void codothers(String url,String uName,String pwd,String sName,String cName,String ADD1,String ADD2,String ADD3,String sPincode,String sEmail,String sNum,String rName,String addR1,String addR2,String addR3,String rPincode,String rEmail,String rMobNum,String parcel,String codamt,String length,String Width,String height,String wt,String value,String custRef,String invNum) throws Exception {
		try {
			test = extent.createTest("CreateShip-Others-Parcel-Commercial-COD","Login with positive credentials");
			 driver.get(url);
		...
		ArrayList<String> excelData = ReadExcelCODothers.getExcelList();
