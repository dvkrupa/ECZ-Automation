...
import utils.CODutils;
import utils.ReadexcelCOD;


public class CreateShipCOD extends CODutils{
...
@Test(dataProvider = "CreateShipCOD")
	public void createshipCOD(String url,String uName,String pwd, String rName,String addR1,String addR2,String addR3,String rPincode,String rEmail,String rMobNum,String parcel,String codamt,String length,String Width,String height,String wt,String value,String custRef,String invNum) throws Exception {
	try {
	//Create a test case and assign test details
	 test = extent.createTest("CreateShip-Parcel-Commercial-COD","Login with positive credentials");
	 driver.get(url);
	...
	WebElement CODamt = driver.findElement(By.xpath("//input[@formcontrolname='cod_amount']"));
	CODamt.sendKeys(codamt);
	...
	ArrayList<String> excelData = ReadexcelCOD.getExcelList();
	System.out.println("ExcelList: "+excelData);
	...
	WebElement CODcharge = driver.findElement(By.cssSelector("html>body>app-root>app-shipment>div>div>app-listing>div>div>div>div:nth-of-type(2)>div>div>table>tbody>tr:nth-of-type(2)>td>div>div>div>div>table>tbody>tr>td:nth-of-type(4)>b:nth-of-type(2)"));
	String codCharge = CODcharge.getText();
	int charge = codCharge.indexOf('.');
	int codvalue = codCharge.length();
	String CODvalue = codCharge.substring(charge+1, codvalue);
	System.out.println("COD charge is::" +CODvalue);
	...
	WebElement Dimension = driver.findElement(By.xpath("html[1]/body[1]/app-root[1]/app-shipment[1]/div[1]/div[1]/app-listing[1]/div[1]/div[1]/div[1]/div[2]/div[1]/div[1]/table[1]/tbody[1]/tr[2]/td[1]/div[1]/div[1]/div[3]/div[1]/table[1]/tbody[1]/tr[1]/td[2]"));
	...
	int length2 = LabelHeight.length()-3;
	String height1 = LabelHeight.substring(0, length2);
