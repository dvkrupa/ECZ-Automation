...
public class ReadExcelCreateOthersDocument {
	@BeforeMethod(enabled=true)
	public static String[][] getExcelOthersDocdata() {
		String fileLocation = "./Excel-Data/eCourierzCreateShipment.xlsx";
...
public static ArrayList<String> getExcelList() throws Exception  {
	String fileLocation = "./Excel-Data/eCourierzCreateShipment.xlsx";
	XSSFWorkbook wbook = null;
	try {
		wbook = new XSSFWorkbook(fileLocation);
	...
	for (int i = 1; i <=lastRowNum; i++) {
		...
		for (int j = 0; j <lastCellNum; j++) {
            ...
            if(!FirstRow.equalsIgnoreCase("URL") && !FirstRow.equalsIgnoreCase("UserName") &&
            	!FirstRow.equalsIgnoreCase("PassWord")&& !FirstRow.equalsIgnoreCase("Length")&&
            	!FirstRow.equalsIgnoreCase("Width")&& !FirstRow.equalsIgnoreCase("Height")){
